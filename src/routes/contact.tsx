...
function Contact() {
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <Modal title="Help Center Failed To Load" onClose={() => setIsModalOpen(false)}>
          <h2 className="mb-4 text-2xl font-bold">Help Center Failed To Load</h2>
          <p className="mb-12 pr-6">
            Something is causing our Help Center to not load properly. This typically occurs when our customers have an
            ad-blocker or Javascript disabled. Please double check these settings or you can reach out to us directly at{' '}
            <a
              href={
                'mailto:support@salad.com?subject=' +
                encodeURIComponent('I Need Help with Salad') +
          ...
          <div className="flex justify-center">
            <button
              className="relative flex w-full items-center justify-center rounded-sm border border-green-900 bg-transparent p-2 text-green-900"
