...
that the Job itself [encountered an error](/faq/jobs/why-do-jobs-keep-failing-or-restarting) and failed.
...
- Make sure that your PC is
  [set up correctly for Container Jobs](/troubleshooting/container-jobs/container-workloads-troubleshooting).
- That you're not running any other programs that could
  [utilize your hardware resources](/faq/salad-app/temporary-workload-block).
