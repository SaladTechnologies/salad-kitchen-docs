...
If Salad still isn't working quite right after [whitelisting in your Antivirus software](/troubleshooting/antivirus/),
there are a few extra steps to try:
...
2. Double Check that your PC is Compatible.
   1. There is a chance that your PC is simply incompatible with Salad, you can check the system requirements
      [on this article here](/faq/compatibility/is-my-machine-compatible-with-salad).

3. Try Updating WSL.
   1. Follow [this guide](/guides/your-pc/how-to-update-the-wsl-kernel-on-your-machine) to update WSL on your machine.
...
7. Update your GPU Drivers.
   1. If you haven't updated your GPU drivers in a while, it's possible that Salad and its containers might not be
      ...
      1. [AMD drivers](/guides/your-pc/how-to-update-my-amd-drivers) if you own an AMD dedicated GPU
      2. [NVIDIA drivers](/guides/your-pc/how-to-update-my-nvidia-drivers) if you own an NVIDIA GPU
