...
<Callout type="info">
  As PayPal rewards have to go through a transaction page, please allow up to 24 hours for the transaction to be
  completed and the balance received on your account.
</Callout>
