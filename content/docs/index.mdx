...
<iframe
  ...
  src="https://www.youtube.com/embed/KfnITKAuxHE"
  width="100%"
  height="480px"
  frameBorder="0"
...
[minimum system requirements](/faq/compatibility/is-my-machine-compatible-with-salad) and then
...
- **Installing WSL (Windows Subsystem for Linux)**: Salad uses [WSL](/faq/jobs/what-is-wsl) to run jobs on your machine.
  If you don't have WSL installed, the app will guide you through the installation process.
- **Configuring Settings**: You can customize your Salad experience by adjusting what workloads you're opted in to run.
  You can adjust this later in [Settings](/guides/using-salad/salad-app-settings).
...
[Reward Vault](/guides/using-salad/where-to-find-your-reward-redemption-code) and in your email.
