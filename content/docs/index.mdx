...
[minimum system requirements](/docs/faq/compatibility/78-is-my-machine-compatible-with-salad) and then
...
- **Installing WSL (Windows Subsystem for Linux)**: Salad uses [WSL](/docs/faq/jobs/265-what-is-wsl) to run jobs on your
...
- **Configuring Settings**: You can customize your Salad experience by adjusting what workloads you're opted in to run.
  You can adjust this later in [Settings](/docs/guides/using-salad/353-salad-app-settings).
...
[Reward Vault](/docs/guides/using-salad/125-where-to-find-your-reward-redemption-code) and in your email.
