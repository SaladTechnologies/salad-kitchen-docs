...
[Windows 10 or Windows 11](/faq/compatibility/do-you-support-macos-and-linux) PC. Additional information on the minimum
and recommended system requirements can be found [here](/faq/compatibility/is-my-machine-compatible-with-salad).
...
> [here](/guides/your-pc/how-to-check-if-your-salad-installer-is-safe).

Next, you'll [register and log in to the Salad application](/guides/getting-started/how-to-register-and-log-into-salad).
