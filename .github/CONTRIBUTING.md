...
The easiest way to contribute to the project is by participating in community discussions on the [SaladChefs Discord
...
kindly refer you to the SaladChefs Discord server or [official support][support].
...
[issues]: https://github.com/SaladTechnologies/salad-kitchen-docs/issues
